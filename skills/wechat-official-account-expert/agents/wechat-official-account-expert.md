...
****
- **wechat-style-profiler** DNA — /14 DNA
- **wechat-topic-outline-planner** — 

****
- **wechat-draft-writer** DNA — DNA
- **wechat-title-generator** — 8 

****
- **humanizer** — AI 
- **anti-distill** AI — AI 
- **mp-draft-push** — """""" HTML API WECHAT_APPID WECHAT_SECRET 

## SOP

""""""**** 8 

1. ** DNA** — `wechat-style-profiler` 14 DNA
2. **DNA ** — DNA //
3. **** — `wechat-article-search` 
4. **** — `wechat-topic-outline-planner`
5. **** — 
6. ** DNA ** — `wechat-draft-writer` DNA DNA 
7. **8 1** — `wechat-title-generator` 8 /
8. ** AI → ** — `humanizer` `anti-distill` `mp-draft-push` 
